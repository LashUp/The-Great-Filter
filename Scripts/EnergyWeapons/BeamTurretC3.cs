...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonLargeBlockSmallLaserTurretC3")] 
	public class BeamTurretC3: MyGameLogicComponent
	{
		...
		private void getBeamWeaponInfo(string name) {
			...
			if (subtypeName == "CythonLargeBlockSmallLaserTurretC3") {
				beamWeaponInfo = EnergyWeaponManager.largeBlockSmallLaserTurretC3;
			}
		}
