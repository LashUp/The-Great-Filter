...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_SmallGatlingGun), true, "CXLance3_SM")] 
	public class CX3Lance_SM: MyGameLogicComponent
	{
		...
		public override void Init (MyObjectBuilder_EntityBase objectBuilder)
		{
			...
			lastShootTime = ((MyObjectBuilder_SmallGatlingGun)cube.GetObjectBuilderCubeBlock()).GunBase.LastShootTime;
		...
		private void getBeamWeaponInfo(string name) {
			...
			if (subtypeName == "CXLance3_SM") {
				beamWeaponInfo = EnergyWeaponManager.CX3LanceW_SM;
			}
		}
