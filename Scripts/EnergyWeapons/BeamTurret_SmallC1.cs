...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonSmallBlockSmallLaserTurretC1")] 
	public class BeamTurret_SmallC1: MyGameLogicComponent
	{
		...
		private void getBeamWeaponInfo(string name) {
			...
			if (subtypeName == "CythonSmallBlockSmallLaserTurretC1") {
				beamWeaponInfo = EnergyWeaponManager.smallBlockSmallLaserTurretC1;
			}
		}
