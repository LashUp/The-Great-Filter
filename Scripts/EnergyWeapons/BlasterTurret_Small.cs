...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonSmallBlockSmallPlasmaTurret")] 
	public class BlasterTurret_Small: MyGameLogicComponent
    {
        ...
        private void getPulseWeaponInfo(string name) {
			...
			if (subtypeName == "CythonSmallBlockSmallPlasmaTurret") {
				pulseWeaponInfo = EnergyWeaponManager.smallBlockSmallBlasterTurret;
			}
		}
