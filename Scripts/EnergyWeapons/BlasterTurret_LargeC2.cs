...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonLargeBlockSmallBlasterTurretC2")] 
	public class BlasterTurret_LargeC2: MyGameLogicComponent
    {
        ...
        private void getPulseWeaponInfo(string name) {
			...
			if (subtypeName == "CythonLargeBlockSmallBlasterTurretC2") {
				pulseWeaponInfo = EnergyWeaponManager.largeBlockSmallBlasterTurretC2;
			}
		}
