...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonLargeBlockSmallLaserTurretC2")] 
	public class BeamTurretC2: MyGameLogicComponent
	{
		...
		private void getBeamWeaponInfo(string name) {
			...
			if (subtypeName == "CythonLargeBlockSmallLaserTurretC2") {
				beamWeaponInfo = EnergyWeaponManager.largeBlockSmallLaserTurretC2;
			}
		}
