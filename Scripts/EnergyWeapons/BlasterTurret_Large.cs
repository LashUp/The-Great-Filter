...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonLargeBlockSmallBlasterTurret")] 
	public class BlasterTurret_Large: MyGameLogicComponent
    {
        ...
        private void getPulseWeaponInfo(string name) {
			...
			if (subtypeName == "CythonLargeBlockSmallBlasterTurret") {
				pulseWeaponInfo = EnergyWeaponManager.largeBlockSmallBlasterTurret;
			}
		}
