...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_SmallGatlingGun), true, "CXLance3")] 
	public class CX3Lance: MyGameLogicComponent
	{
		...
		private void getBeamWeaponInfo(string name) {
			...
			if (subtypeName == "CXLance3") {
				beamWeaponInfo = EnergyWeaponManager.CX3LanceW;
			}
		}
