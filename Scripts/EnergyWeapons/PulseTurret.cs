...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonLargeBlockSmallPlasmaTurret")] 
	public class PulseTurret: MyGameLogicComponent
	{
		...
		private void getPulseWeaponInfo(string name) {
			...
			if (subtypeName == "CythonLargeBlockSmallPlasmaTurret") {
				pulseWeaponInfo = EnergyWeaponManager.largeBlockSmallPlasmaTurret;
			}
		}
