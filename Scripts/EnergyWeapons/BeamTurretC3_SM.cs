...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CX3LG_SM_Laser")] 
	public class BeamTurretC3_SM: MyGameLogicComponent
	{
		...
		private void getBeamWeaponInfo(string name) {
			...
			if (subtypeName == "CX3LG_SM_Laser") {
				beamWeaponInfo = EnergyWeaponManager.WPN_CX3LG_SM_Laser;
			}
		}
