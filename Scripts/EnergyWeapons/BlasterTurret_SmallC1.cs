...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonSmallBlockSmallPlasmaTurretC1")] 
	public class BlasterTurret_SmallC1: MyGameLogicComponent
    {
        ...
        private void getPulseWeaponInfo(string name) {
			...
			if (subtypeName == "CythonSmallBlockSmallPlasmaTurretC1") {
				pulseWeaponInfo = EnergyWeaponManager.smallBlockSmallBlasterTurretC1;
			}
		}
