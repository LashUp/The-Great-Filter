...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonSmallBlockSmallPlasmaTurretC3")] 
	public class BlasterTurret_SmallC3: MyGameLogicComponent
    {
        ...
        private void getPulseWeaponInfo(string name) {
			...
			if (subtypeName == "CythonSmallBlockSmallPlasmaTurretC3") {
				pulseWeaponInfo = EnergyWeaponManager.smallBlockSmallBlasterTurretC3;
			}
		}
