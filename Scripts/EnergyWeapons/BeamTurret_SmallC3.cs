...
{
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonSmallBlockSmallLaserTurretC3")] 
	public class BeamTurret_SmallC3: MyGameLogicComponent
	{
		...
		private void getBeamWeaponInfo(string name) {
			...
			if (subtypeName == "CythonSmallBlockSmallLaserTurretC3") {
				beamWeaponInfo = EnergyWeaponManager.smallBlockSmallLaserTurretC3;
			}
		}
