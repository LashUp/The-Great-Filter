...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_SmallGatlingGun), true, "Fixed_BlasterCX3")]
    public class FixedBlasterCX3_Small : MyGameLogicComponent
    {
        ...
        {
            if (subtypeName == "Fixed_BlasterCX3")
            {
                pulseWeaponInfo = EnergyWeaponManager.FixedBlasterCX3W;
            }
        }
