...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true, "CythonLargeBlockSmallBlasterTurretC3")] 
	public class BlasterTurret_LargeC3: MyGameLogicComponent
    {
        ...
        private void getPulseWeaponInfo(string name) {
			...
			if (subtypeName == "CythonLargeBlockSmallBlasterTurretC3") {
				pulseWeaponInfo = EnergyWeaponManager.largeBlockSmallBlasterTurretC3;
			}
		}
