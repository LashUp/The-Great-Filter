...
{
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_SmallGatlingGun), true, "Fixed_Blaster")]
    public class FixedBlaster_Small : MyGameLogicComponent
    {
        ...
        {
            if (subtypeName == "Fixed_Blaster")
            {
                pulseWeaponInfo = EnergyWeaponManager.FixedBlasterW;
            }
        }
